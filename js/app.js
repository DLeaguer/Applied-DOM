(function(window) {
   ...
   * console.log(this) to see the lightId's id
   *
  ...
  function setMyLightGreen() {
    ...
    console.log('btn id ---> ', this.dataset.lightId);
    
    document.getElementById(this.dataset.lightId).className = 'light-green';
  }
  ...
  function setMyLightClass(event, desiredClass) {
    ...
    document.getElementById(this.dataset.lightId).className = desiredClass;
  }
